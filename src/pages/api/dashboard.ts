...
export const dashboardData = async () => {
    try {
        ...
        const data = await axios.get(`${LOCAL_BASE_URL}/users/getEc2StorageUtilization/767397878280`, { headers: headers });
...
export const getS3Data = async () => {
    try {
        ...
        const data = await axios.get(`${LOCAL_BASE_URL}/users/gets3data/767397878280`, { headers: headers });
        return data;
    } catch (error: any) {
        return error?.response;
    }
